  ...
  return (
    <>
      <div className="bg-[--item-border] dark-transition h-40 md:h-60 lg:h-72 xl:h-80 relative">
        ...
        <h1 className="w-full text-center font-bold text-2xl md:text-3xl lg:text-4xl xl:text-5xl theme-item absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          {title}
          <span
                        ...
                        <div>
                          ...
                          {option.types.map((type) => {
                            return (
                              <>
                                <span
                                  className="inline-block text-xs md:text-sm lg:text-base xl:text-lg mr-2 mb-2 bg-[--item-border] theme-item px-2 py-1"
                                  key={type.text}
                                >
                                  {type.text}
                                </span>
