...
export default function Items(contents: Blog) {
  ...
  return (
    <>
      <input className="ml-auto block w-48 md:w-60 rounded mb-10 py-1 md:py-2 px-2 md:px-3 text-base font-medium theme-item" placeholder="Search" type="text" value={inputValue} onChange={handleChange} />
      <PageWrapper>
