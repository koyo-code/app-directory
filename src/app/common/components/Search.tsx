...
export default function Items(contents: Blog) {
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 md:gap-6 gap-4">
          ...
          return (
            ...
            >
              <div className="relative">
                <span
                  className={`inline-block py-1 md:py-2 px-4 text-xs md:text-sm absolute top-0 right-0 ${member.genre[0]}`}
                >
                  {member.genre[0]}
                </span>
                <h3 className="font-bold text-lg md:text-xl xl:md:text-2xl flex justify-center items-center w-full h-auto aspect-[5/3] theme-item">
                  {member.title}
                </h3>
              </div>
